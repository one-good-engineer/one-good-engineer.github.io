...
const copy = {
  en: {
    ...
    heroB: "Three working directions in 48 hours. Your choice, your domain, a date for launch.",
    ...
    consoleBadge: "7 working days",
    trace: [["00", "brief", "four fields, one minute"], ["01", "directions", "three live routes, 48 hours"], ["02", "decision", "one route to refine"], ["03", "revision", "one round included"], ["04", "launch", "your domain, day seven"], ["05", "support", "changes by email"]],
    metrics: [["scope", "agreed"], ["ownership", "yours"], ["support", "monthly"]],
    proof: [["48h", "to see three working directions"], ["7 days", "to launch a company website"], ["1 email", "to request a small change"], ["100%", "of the code and content stay yours"]],
    ...
    flow: [["Brief", "Tell me who you serve, what you sell and what the site should make easier. Four fields start the conversation; the detailed questions arrive by email. No discovery workshop needed."], ["Three directions", "Within 48 hours you receive three working versions with different layouts and tones. They are real pages you can open on your phone, not slides that still need to become a website."], ["Choice and revision", "You choose the direction with the best chance of working for your business. One round of changes is included, with a clear fixed price for anything beyond the agreed scope."], ["Launch and care", "Your company website goes live on your domain within seven working days. After that, small updates are one email away and the site remains yours even if you stop the support plan."]],
    ...
    plans: [{name: "Company website", price: "from 2 990 PLN", priceNote: "net, one-off", lead: "A focused site of up to six pages that makes your offer easy to understand and easy to act on.", items: ["Three working directions within 48 hours", "Page structure and copy drafted from your brief", "Your photos or carefully licensed images", "Contact form, map and Google Business link", "Privacy policy and cookie-free analytics", "Live on your domain within seven working days"], cta: "Start a company website"}, {name: "Online shop", price: "from 7 900 PLN", priceNote: "net, one-off", lead: "A shop that is ready to sell, compliant from day one and independent of a marketplace's margin.", items: ["Three working directions within 48 hours", "Up to 200 products imported from your file", "Przelewy24, PayU or Stripe payments", "InPost or courier delivery setup", "Omnibus price history and WCAG 2.1 AA", "BaseLinker, Allegro and ERP integrations as fixed add-ons", "Live on your domain within 21 working days"], cta: "Start an online shop", featured: true}, {name: "Shop compliance audit", price: "1 490 PLN", priceNote: "net, credited against the fix", lead: "A practical check for a shop that already exists and has not been reviewed since the rules changed.", items: ["Omnibus: price history, promotions and reviews", "Accessibility against WCAG 2.1 AA", "Speed and mobile checkout walk-through", "Report within five working days", "Fixed price for every recommended fix", "Audit fee deducted if you order the fixes"], cta: "Check my shop"}] satisfies readonly Plan[],
    ...
    whyTitle: "Three directions are included because choosing well is part of the job.",
  ...
  pl: {
    ...
    heroB: "Trzy działające kierunki w 48 godzin. Ty wybierasz, ja dowożę publikację.",
    ...
    consoleBadge: "7 dni roboczych",
    trace: [["00", "brief", "cztery pola, minuta"], ["01", "kierunki", "trzy działające wersje, 48 godzin"], ["02", "decyzja", "wybierasz jeden kierunek"], ["03", "poprawki", "jedna runda w cenie"], ["04", "publikacja", "Twoja domena, dzień siódmy"], ["05", "opieka", "zmiany mailem"]],
    metrics: [["zakres", "ustalony"], ["własność", "Twoja"], ["opieka", "miesięczna"]],
    proof: [["48 h", "do zobaczenia trzech kierunków"], ["7 dni", "do publikacji strony firmowej"], ["1 mail", "żeby zlecić drobną zmianę"], ["100%", "kodu i treści zostaje u Ciebie"]],
    ...
    flow: [["Brief", "Napisz, komu sprzedajesz, co oferujesz i co strona ma ułatwić. Cztery pola uruchamiają rozmowę, a szczegółowe pytania dostajesz mailem. Bez warsztatu odkrywczego."], ["Trzy kierunki", "W ciągu 48 godzin dostajesz trzy działające wersje o różnym układzie i tonie. To prawdziwe strony, które otworzysz na telefonie, a nie slajdy czekające na wdrożenie."], ["Wybór i poprawki", "Wybierasz kierunek z największą szansą na wynik dla Twojej firmy. Jedna runda zmian jest w cenie, a wszystko poza ustalonym zakresem dostaje stałą wycenę przed startem."], ["Publikacja i opieka", "Strona firmowa działa pod Twoją domeną w ciągu siedmiu dni roboczych. Później drobne zmiany zlecasz jednym mailem, a strona nadal należy do Ciebie także po rezygnacji z opieki."]],
    ...
    plans: [{name: "Strona firmowa", price: "od 2 990 zł", priceNote: "netto, jednorazowo", lead: "Do sześciu podstron, które jasno pokazują ofertę i prowadzą klienta do kontaktu.", items: ["Trzy działające kierunki w 48 godzin", "Struktura podstron i teksty przygotowane z briefu", "Twoje zdjęcia albo starannie dobrane licencjonowane", "Formularz kontaktowy, mapa i wizytówka Google", "Polityka prywatności i analityka bez ciasteczek", "Publikacja pod Twoją domeną w siedem dni roboczych"], cta: "Zacznij stronę firmową"}, {name: "Sklep internetowy", price: "od 7 900 zł", priceNote: "netto, jednorazowo", lead: "Sklep gotowy do sprzedaży, zgodny z przepisami i niezależny od marży marketplace'u.", items: ["Trzy działające kierunki w 48 godzin", "Do 200 produktów z Twojego pliku", "Płatności Przelewy24, PayU lub Stripe", "Dostawa InPost albo kurierem", "Historia cen Omnibus i dostępność WCAG 2.1 AA", "Integracje BaseLinker, Allegro i ERP jako stałe dodatki", "Publikacja pod Twoją domeną w 21 dni roboczych"], cta: "Zacznij sklep", featured: true}, {name: "Audyt zgodności sklepu", price: "1 490 zł", priceNote: "netto, odliczane od naprawy", lead: "Praktyczna kontrola sklepu, który działa, ale nie był sprawdzany od czasu zmian w przepisach.", items: ["Omnibus: historia cen, promocje i opinie", "Dostępność według WCAG 2.1 AA", "Szybkość i koszyk na telefonie", "Raport w pięć dni roboczych", "Stała cena każdej rekomendowanej poprawki", "Koszt audytu odliczony przy zamówieniu napraw"], cta: "Sprawdź sklep"}] satisfies readonly Plan[],
    ...
    whyTitle: "Trzy kierunki są w cenie, bo dobry wybór jest częścią pracy.",
