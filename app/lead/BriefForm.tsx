...
const copy = {
  en: {
    ...
    sending: "Sending...",
    aside: "One minute here. The ten brief questions come back to you by email, and the 48 hours start when you answer them.",
    sent: "Thank you. The brief questions are on their way to you; the 48 hours to three working versions start when your answers arrive.",
  ...
  pl: {
    ...
    send: "Zacznij brief",
    sending: "Wysyłam...",
    aside: "Tu minuta. Dziesięć pytań briefu wraca do Ciebie mailem, a 48 godzin liczy się od Twoich odpowiedzi.",
    sent: "Dziękuję. Pytania briefu są w drodze do Ciebie; 48 godzin do trzech działających wersji liczy się od Twoich odpowiedzi.",
