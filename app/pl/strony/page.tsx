...
export const metadata: Metadata = {
  ...
  description:
    "Pełna obsługa strony dla firmy: strategia, teksty, design, wdrożenie, SEO, hosting i domena. Trzy działające kierunki w 48 godzin, stała cena i opieka po publikacji.",
  ...
  openGraph: {
    ...
    description: "Strategia, teksty, design, SEO, hosting i domena w jednej usłudze. Trzy działające kierunki w 48 godzin, stała cena i opieka.",
    locale: "pl_PL",
  },
};
