...
test("draft supports undecided clients without making up a service", () => {
  const draft = buildLeadMessage({}, "https://example.test/pl/automatyzacje/", "owner@example.test");
